...
function self:FindInAABB (aabb3d, spatialQueryResults)
	GCAD.Error ("ISpatialQueryable3d:FindInAABB : Not implemented.")
end

function self:FindIntersectingAABB (aabb3d, spatialQueryResults)
	GCAD.Error ("ISpatialQueryable3d:FindIntersectingAABB : Not implemented.")
end

function self:FindInSphere (sphere3d, spatialQueryResults)
	GCAD.Error ("ISpatialQueryable3d:FindInSphere : Not implemented.")
end

function self:FindIntersectingSphere (sphere3d, spatialQueryResults)
	GCAD.Error ("ISpatialQueryable3d:FindIntersectingSphere : Not implemented.")
end

function self:FindInPlane (plane3d, spatialQueryResults)
	GCAD.Error ("ISpatialQueryable3d:FindInPlane : Not implemented.")
end

function self:FindIntersectingPlane (plane3d, spatialQueryResults)
